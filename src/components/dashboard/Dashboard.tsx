...
export default function Dashboard() {
  ...
  const { data: eventsCnt, isLoading: eventsLoading } =
    useSuspenseQuery(countOnlyEvents);
  const { data: usersCnt, isLoading: usersLoading } =
    useSuspenseQuery(countOnlyUsers);
  const { data: ticketsCnt, isLoading: ticketsLoading } =
    useSuspenseQuery(countOnlyTickets);
  const { data: eventsList, isLoading: eventsListLoading } =
    useSuspenseQuery(events);
  const { data: usersList, isLoading: usersListLoading } =
